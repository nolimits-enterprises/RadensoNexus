...
public class DS1KaMute extends DS1ServiceActionACtivity {
        ...
        sb.setOnSeekBarChangeListener(new SeekBar.OnSeekBarChangeListener() {
            ...
            public void onProgressChanged(SeekBar seekBar, int progress,
                ...
                if (fromUser)
                {
                    if (mDS1Service != null)
                    {
                        mDS1Service.setKaLowSpeedMute(progress * (metric ? 10 : 5));
                        setMRCDText();
    ...
    void onGotResult()
    {
        DS1KaMute.this.runOnUiThread(new Runnable(){
            ...
            public void run() {
                ...
                int speed = mDS1Service.getmSetting().ka_low_speed_mute;
                if (speed > 0) {
                    if (metric) {
                        speed /= 10;
                        sb.setMax(10);
