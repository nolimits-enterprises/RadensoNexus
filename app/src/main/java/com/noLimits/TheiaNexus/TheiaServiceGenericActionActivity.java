...
public class TheiaServiceGenericActionActivity extends TheiaServiceActionActivity {
    ...
    {
        mTheiaService.writeGeneric(settingName, selectedValue);
    }
    ...
    protected void sendSelected(int s)
    {
        ...
        mTheiaService.writeGeneric(settingName, s);
    }
    ...
    protected void onConnectedTask()
    {
        if (mTheiaService != null)
        {
            ...
            mTheiaService.readValue(settingName);
        }
    }
